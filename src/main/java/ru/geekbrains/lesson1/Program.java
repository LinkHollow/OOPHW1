...
//        System.out.println(product1.displayInfo());
        ...
        Product СhocolateBar1 = new СhocolateBar("Красный Октябрь", "Аленка", 215, "Молочный" );
        Product СhocolateBar2 = new СhocolateBar("Красный Октябрь", "Аленка", 290, "Горький" );
        System.out.println(СhocolateBar1.displayInfo());
        ...
        products.add(СhocolateBar1);
        products.add(СhocolateBar2);

        VendingMachine vendingMachine = new VendingMachine(products);
        СhocolateBar СhocolateBarResult = vendingMachine.getChocolateBar("Горький");
        if (СhocolateBarResult != null){
            System.out.println("Вы купили: ");
            System.out.println(СhocolateBarResult.displayInfo());
        }
        else {
            System.out.println("Такого товара нет в атомате");
        }
    }
